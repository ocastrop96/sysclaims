...
-- Tiempo de generación: 26-11-2021 a las 17:31:45
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ListarUsuarios` ()  SELECT
	...
	sc_usuario.clave, 
	sc_usuario.intentos,
	date_format(sc_usuario.fechaAlta,'%d/%m/%Y')
FROM
	sc_usuario
	INNER JOIN
	sc_perfil
...
INSERT INTO `sc_causaespecifica` (`idCausaEsp`, `descCausaEsp`, `derechoId`, `estadoItem`) VALUES
(1, 'Demora en emision de carta de garantía por la IAFAS cuando corresponda', 1, 0),
(2, 'De la solicitud de afiliación', 1, 0),
(3, 'Demora en el proceso de afiliación al SIS', 1, 0),
(4, 'Demora en la entrega de formatos', 1, 0),
(5, 'De solicitud de la carta de garantía cuando corresponda', 2, 0),
(6, 'Demora en la entrega de la hoja de referencia a un establecimiento de mayor complejidad u otra IPRESS', 2, 0),
(7, 'Demora en la entrega de otros formatos', 2, 0),
(8, 'Demora en la atención de emergencia', 3, 0),
(9, 'Demora en la atención de consultorio externo', 3, 0),
(10, 'Demora en la hospitalización', 3, 0),
(11, 'Demora en la realización de exámenes o intervenciones asistenciales', 3, 0),
(12, 'Demora en la intervencion quirúrgica', 3, 0),
(13, 'Demora en la referencia', 3, 0),
(14, 'Por plataforma de atención de IPRESS', 4, 0),
(15, 'Problemas relacionados al lenguaje', 4, 0),
(16, 'Por otras instancias de la IPRESS', 4, 0),
(17, 'Demora en la admisión del asegurado en la IPRESS o en los servicios de apoyo al diagnóstico', 5, 0),
(18, 'Demora en llegada de ambulancia o atención a domicilio', 5, 0),
(19, 'Demora de atención del asegurado en la central telefónica', 5, 0),
(20, 'Demora en la atención al asegurado en la plataforma de atención', 5, 0),
(21, 'Incumplimiento de citas en la IPRESS', 5, 0),
(22, 'La IPRESS no cumple con el horario establecido', 5, 0),
(23, 'Oportunidad de referencia a otro establecimiento de salud o servicio', 5, 0),
(24, 'Asignación o cambio de médico tratante en la IPRESS sin consentimiento expreso del asegurado', 5, 0),
(25, 'No disponibilidad de servicio de salud en lugar de residencia', 5, 0),
(26, 'Relacionados al contrato entre la IAFAS y la IPRESS', 5, 0),
(27, 'Otras relacionadas con el acceso a los servicios', 5, 0),
(28, 'La IPRESS al prestar servicios no incluidos en el plan de salud', 6, 0),
(29, 'Por cobros no autorizados por servicios ot orgados que superen los límites de la cobertura', 6, 0),
(30, 'Rechazo de atención en periodo de carencia', 6, 0),
(31, 'Otros relacionados con gastos no cubiertos', 6, 0),
(32, 'Cobros adicionales a las tarifas contractualmente pactadas', 7, 0),
(33, 'Cobros en emergencia', 7, 0),
(34, 'Otros relacionados con los cobros por la atención', 7, 0),
(35, 'En los casos que el reclamo, de orden administrativo, no corresponda a las causales señaladas', 8, 0),
(36, 'Relacionado con la evaluación durante la consulta médica ambulatoria o en emergencia', 9, 0),
(37, 'Sobre la información del personal responsable de la atención', 9, 0),
(38, 'Sobre información de la prestación de salud', 9, 0),
(39, 'Relacionado con el diagnóstico', 9, 0),
(40, 'Relacionado con la atención de consulta médica o emergencia a domicilio', 9, 0),
(41, 'Relacionado con el tratamiento médico ambulatorio , a domicilio o en emergencia', 9, 0),
(42, 'Relacionado con la referencia o traslado', 9, 0),
(43, 'Demora en la atención en el servicio de emergencia', 9, 0),
(44, 'Relacionado con el tratamiento quirúrgico', 9, 0),
(45, 'Relacionado con la hospitalización', 9, 0),
(46, 'Relacionado con el examen o procedimiento auxiliar', 9, 0),
(47, 'Relacionado con la información al paciente por el médico', 9, 0),
(48, 'Otros relacionados con la calidad de la atención', 9, 0),
(49, 'Indumentaria del personal asistencial', 10, 0),
(50, 'Ambientes', 10, 0),
(51, 'Equipos, instrumental biomédico e insumos', 10, 0),
(52, 'Otros relacionados con la salubridad', 10, 0),
(53, 'Infraestructura', 11, 0),
(54, 'Equipamiento', 11, 0),
(55, 'Otros', 11, 0),
(56, 'Cambio de medicamento', 12, 0),
(57, 'Relacionado con la receta', 12, 0),
(58, 'Demora en la entrega de medicamentos e insumos', 12, 0),
(59, 'No conformidad con el medicamento indicado', 12, 0),
(60, 'Falta de medicamento o insumos en la IPRESS', 12, 0),
(61, 'Error en la entrega de medicamento', 12, 0),
(62, 'Negativa en la entrega de medicamentos e insumos', 12, 0),
(63, 'Medicamento no cubierto o excluido', 12, 0),
(64, 'Otros relacionados con el suministro de medicamentos e insumos médicos', 12, 0),
(65, 'Discriminación al asegurado en los servicios de la IPRESS o la IAFAS', 13, 0),
(66, 'Descortesía en personal administrativo en la IPRESS', 13, 0),
(67, 'Trabas a la comunicación del asegurado con sus familiares', 13, 0),
(68, 'Descortesía en el personal médico', 13, 0),
(69, 'Descortesía en el personal asistencial no médico', 13, 0),
(70, 'Violación a la confidencialidad de datos del usuario', 14, 0),
(71, 'Falta de confidencilaidad de la información sobre el asegurado ', 14, 0),
(72, 'Presencia de personal no autorizado en evaluación clínica', 14, 0),
(73, 'Atención de salud brindada en condiciones de exposición', 14, 0),
(74, 'Registro no consentido de imágenes personales', 14, 0),
(75, 'Falta de consentimiento informado', 14, 0),
(76, 'En los casos que el reclamo de carácter prestacional no corresponda a las causales señaladas', 15, 0),
...
CREATE TABLE `sc_derecho` (
  ...
  `descDerecho` text COLLATE utf8_bin,
  `estadoItem` int(11) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `sc_derecho` (`idDerecho`, `descDerecho`, `estadoItem`) VALUES
(1, 'Demora en la entrega de formatos por la IAFAS', 0),
(2, 'Demora en la entrega de formatos en la IPRESS', 0),
(3, 'Demora en la prestacion de servicio de salud', 0),
(4, 'Deficiencia en la información brindada en la IPRESS', 0),
(5, 'Dificultad de acceso a los servicios de atención al asegurado', 0),
(6, 'Disconformidad por el cobro de gastos no cubiertos', 0),
(7, 'Disconformidad con los cobros por la atención', 0),
(8, 'Otros relativos a la oportunidad', 0),
(9, 'Calidad de atención de salud', 0),
(10, 'Deficiencia en el orden, limpieza y bioseguridad de la IPRESS', 0),
(11, 'Relativos a la infraestructura y el \nequipamiento', 0),
(12, 'No conformidad con la prescripción, el suministro de medicamentos o insumos en la IPRESS', 0),
(13, 'Disconformidad con el trato recibido', 0),
(14, 'Confidencialidad y Consentimiento informado', 0),
(15, 'Otros relativos a la prestación', 0),
...
INSERT INTO `sc_estadoreclamo` (`idEstadoRec`, `descEstadoRec`) VALUES
(1, 'REGISTRADO'),
(2, 'FUNDADO'),
(3, 'INFUNDADO'),
(4, 'IMPROCEDENTE');
...
CREATE TABLE `sc_reclamo` (
  ...
  `apellidoPat` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `apellidoMat` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  ...
  `nombresR` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `emailRep` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  ...
  `estadoRec` int(11) DEFAULT '1',
  `registroSistema` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `sc_tipodocumento` (
  ...
  `descTipoDoc` varchar(50) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `sc_tipodocumento` (`idTipoDoc`, `descTipoDoc`) VALUES
(1, 'DNI'),
...
--
ALTER TABLE `sc_estadoreclamo`
  MODIFY `idEstadoRec` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `sc_causaespecifica`
  ADD CONSTRAINT `derechoidd` FOREIGN KEY (`derechoId`) REFERENCES `sc_derecho` (`idDerecho`);
