...
-- Tiempo de generación: 27-11-2021 a las 03:54:08
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ListarDerechos` ()  SELECT
	...
	sc_derecho.descDerecho,
	sc_derecho.estadoItem,
	sc_estadoitem.descEstadoItem 
FROM
	sc_derecho
	INNER JOIN sc_estadoitem ON sc_derecho.estadoItem = sc_estadoitem.idEstadoItem 
ORDER BY estadoItem ASC, idDerecho$$
