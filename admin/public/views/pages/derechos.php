<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4><strong>Complementos:. Derechos en Salud</strong></h4>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Complementos</a></li>
            <li class="breadcrumb-item active">Derechos en Salud</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Módulo Derechos en Salud &nbsp;<i class="fas fa-balance-scale-right"></i></h3>
      </div>
      <div class="card-body">
        <button type="btn" class="btn btn-secondary" data-toggle="modal" data-target="#modal-registrar-diagnostico"><i class="fas fa-balance-scale-right"></i> Registrar Derecho
        </button>
      </div>
      <div class="card-body">
        <table id="datatableDerechosSGC" class="table table-bordered table-hover dt-responsive datatableDerechosSGC">
          <thead>
            <tr>
              <th style="width: 10px">#</th>
              <th>Derecho en Salud</th>
              <th>Estado</th>
              <th>Acciones</th>
            </tr>
          </thead>
