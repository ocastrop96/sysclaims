<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4><strong>Complementos:. Causas Específicas</strong></h4>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Complementos</a></li>
            <li class="breadcrumb-item active">Causas Específicas</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Módulo Causas Específicas &nbsp;<i class="fas fa-cubes"></i></h3>
      </div>
      <div class="card-body">
        <button type="btn" class="btn btn-secondary" data-toggle="modal" data-target="#modal-registrar-causa"><i class="fas fa-cubes"></i> Registrar Causa
        </button>
      </div>
      <div class="card-body">
        <table id="datatableCausasSGC" class="table table-bordered table-hover dt-responsive datatableCausasSGC">
          <thead>
            <tr>
