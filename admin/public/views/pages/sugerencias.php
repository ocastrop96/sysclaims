<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4><strong>Atención al Usuario:. Sugerencias</strong></h4>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Módulo Sugerencias &nbsp;<i class="fas fa-comment-medical"></i></h3>
      </div>
      <!-- <div class="card-body">
        <button type="btn" class="btn btn-secondary" data-toggle="modal" data-target="#modal-registrar-diagnostico"><i class="fas fa-comment-medical"></i> Registrar Sugerencias
        </button>
      </div> -->
      <div class="card-body">
        <table id="datatableSugerenciSGC" class="table table-bordered table-hover dt-responsive datatableSugerenciSGC">
          <thead>
            <tr>
