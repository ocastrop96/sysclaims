<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4><strong>Atención al Usuario:. Reclamos</strong></h4>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Módulo Reclamos &nbsp;<i class="fas fa-clipboard-list"></i></h3>
      </div>
      <div class="card-body">
        <table id="datatableReclamosSGC" class="table table-bordered table-hover dt-responsive datatableReclamosSGC">
          <thead>
            <tr>
